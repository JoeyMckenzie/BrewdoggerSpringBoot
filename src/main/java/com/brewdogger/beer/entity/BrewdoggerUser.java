...
@Entity
@Table(name = "BREWDOGGER_USERS")
public class BrewdoggerUser {

    @Id
    @SequenceGenerator(name = "USER_ID_GENERATOR", sequenceName = "USER_SEQUENCE", allocationSize = 1, initialValue = 100)
